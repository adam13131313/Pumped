          ...
          <Card key={wp.id}>
            ...
            {isOpen && (
              <CardContent className="pt-0 pb-3">
                ...
                <Button variant="outline" size="sm" onClick={() => { setEditingAction({ id: "", task: "", project: project.name, workPackage: wp.workPackage, dueDate: "", priority: "Medium", status: "Not Started", notes: "" }); setActionDialogOpen(true); }}>
